    ...
    await this.productRepository.manager.transaction(
      async (transacionEntityManager) => {
        ...
        for (const contents of createTransactionDto.contents) {
          const product = await transacionEntityManager.findOneBy(Product, {
          ...
          //Crear instancia de Transaction content
          ...
          await transacionEntityManager.save(transaction);
          await transacionEntityManager.save(transactionContent);
        }
      },
    );
